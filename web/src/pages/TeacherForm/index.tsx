        ...
        <div id="page-teacher-form" className="container">
            ...
            <main>
                ...
                <fieldset>
                    ...
                    <Input name="Дsubject" label="Matщria" type="text"
                        value={subject}
                        onChange={(e) => { setSubject(e.target.value) }}
                      />
                    <Input name="cost" label="Preчo/hora" type="number" min="0" step="0.01"
                        value={cost}
                        onChange={(e) => { setCost(e.target.value) }}
                      />
                    <Input name="schedule" label="Horсrios disponэveis" type="text" />
